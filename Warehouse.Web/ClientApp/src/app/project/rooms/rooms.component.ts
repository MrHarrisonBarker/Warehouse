...
export class RoomsComponent implements OnInit, OnDestroy
{
  ...
  constructor (public chatService: ChatService, private authService: AuthService, private userService: UserService, public dialog: MatDialog)
  {
  }
  ...
  GetRoomUsers (): User[]
  {
    return this.userService.TenantEmployments.filter(x => this.chatService.GetRoomFromStore(this.currentRoomId).memberships.find(m => m.userId == x.id));
  }
